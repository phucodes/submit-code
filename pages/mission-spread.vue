<template>
  <div id="card-template" v-on:scroll="handleScroll">
    <h1>Missions and Launches</h1>
    <nuxt-link class="return" to="people">Return to main page</nuxt-link>
    <div class="card-container">
      <ul class="card" v-for='info in infos.slice(0, 3)' v-bind:key="info.id">
        <li>
...
<script>
import data from "../assets/mission.json";
